# HDI_Office365_get_mails 

Get mails through the Microsoft GRAPH API (4D v19 R8) 

Find more information on the [blog post](https://blog.4d.com/microsoft-365-receive-emails-with-the-microsoft-graph-api/).
